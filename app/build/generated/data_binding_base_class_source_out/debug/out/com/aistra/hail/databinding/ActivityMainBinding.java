...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppBarMainBinding appBarMain, @Nullable BottomNavigationView bottomNav,
      @Nullable NavigationRailView navRail) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, binding_appBarMain, bottomNav,
          navRail);
    }
