...
public final class DialogInputBinding implements ViewBinding {
  ...
  private DialogInputBinding(@NonNull FrameLayout rootView, @NonNull TextInputEditText editText,
  ...
  public static DialogInputBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogInputBinding((FrameLayout) rootView, editText, inputLayout);
    }
